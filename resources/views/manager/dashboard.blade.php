...
@section('title', 'Manager Dashboard | Caring Hands')
    ...
    <div class="dashboard-heading">
        ...
        <div>
            ...
            <p class="dashboard-subtitle">
                Here's an overview of your care operations today.
            </p>
        </div>
            ...
            <div class="overview-content">
                ...
                <div class="overview-details">
                    ...
                    <div class="overview-row">
                        ...
                        <strong>{{ $medicationCount ?? 0 }}</strong>
                    </div>
                                    ...
                                    <div class="resident-user">
                                        <div class="resident-avatar">
                                            @if(!empty($elder->image))
                                                <img src="{{ asset('storage/' . $elder->image) }}"
                                                     alt="{{ $elder->name }}">
                                            @else
                                        ...
                                        <div>
                                            ...
                                            <span>ID #{{ $elder->id }}</span>
                                        </div>
                                    </div>
                                </td>

                                <td>{{ $elder->age ?? '-' }}</td>
                                <td>{{ $elder->caregiver_name ?? 'Not Assigned' }}</td>
                            ...
                            <tr>
                                <td colspan="5">
                                    <div class="empty-table">
                                        ...
                                        <span>Registered residents will appear here.</span>
                                    </div>
                                </td>
                            </tr>
